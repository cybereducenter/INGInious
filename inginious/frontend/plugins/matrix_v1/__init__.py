...
class MatrixPage(INGIniousAdminPage):
    def GET_AUTH(self, courseid): # pylint: disable=arguments-differ
        ...
        return self.template_helper.render("admin.html", 
                                           template_folder='frontend/plugins/matrix_v1',
                                           course=course, 
...
def add_admin_menu(course):
    ...
    return ('matrix_v1', '<i class="fa fa-graduation-cap fa-fw"></i>&nbsp; Matrix V1')
...
def add_course_menu(course, template_helper):
    ...
    html = f'''
        <div class="list-group">
            <a class="list-group-item list-group-item-action list-group-item-info" href="{flask.request.url_root}/admin/{course.get_id()}/matrix_v1">
            <i class="fa fa-graduation-cap fa-fw"></i>&nbsp; Matrix V1
            </a>
        </div>
    '''
    return html
...
def add_css_file():
    ...
    return ('/static/plugins/matrix_v1/matrix_v1.css') ### TODO - change ###
...
def init(plugin_manager, _, _2, _3):
    ...
    plugin_manager.add_page("/admin/<courseid>/matrix_v1", MatrixPage.as_view('matrix_v1'))